...
const Privacy = () => (
  <Container text>
    ...
    Last updated: 30th of December 2018 Tanci Craft ("us", "we", or "our")
    operates http://tanci-craft-dev.netlify.com (the Site). This page informs
    ...
    Information only for providing and improving the Site. By using the Site,
    you agree to the collection and use of information in accordance with this
    policy. Information Collection And Use While using our Site, we may ask you
    ...
    Analytics that collect, monitor and analyze this ... The Log Data section is
    for businesses that use analytics or tracking services in websites or apps,
    ...
    (email newsletters) or other methods. For the full disclosure section,
    ...
    stored on your computer's hard drive. Like many sites, we use "cookies" to
    collect information. You can instruct your browser to refuse all cookies or
    ...
    This Privacy Policy is effective as of 30th of December 2018 and will remain
    ...
    changes to this Privacy Policy, we will notify you either through the email
