...
const Terms = () => (
  <div>
    ...
    <p>
      ...
      in full. Do not continue to use Tanci Craft's website if you do not accept
    ...
    <h2>Cookies</h2>
    <p>
      We employ the use of cookies. By using Tanci Craft's website you consent
      to the use of cookies in accordance with Tanci Craft’s privacy policy.
    </p>
    <p>
    ...
    <h2>License</h2>
    <p>
      Unless otherwise stated, Tanci Craft and/or it’s licensors own the
      intellectual property rights for all material on Tanci Craft. All
      intellectual property rights are reserved. You may view and/or print pages
      from https://tanci-craft-dev.netlify.com for your own personal use subject
    ...
    <ol>
      ...
      <li>
        ...
        https://tanci-craft-dev.netlify.com
      </li>
      <li>
    ...
    <p>
      Redistribute content from Tanci Craft (unless content is specifically made
      for redistribution).
    </p>
    <h2>User Comments</h2>
    <ol>
      ...
      <li>
        ...
        areas of the website. Tanci Craft does not screen, edit, publish or
        review Comments prior to their appearance on the website and Comments do
        not reflect the views or opinions ofTanci Craft, its agents or
        ...
        Tanci Craftshall not be responsible or liable for the Comments or for
        any loss cost, liability, damages or expenses caused and or suffered as
        a result of any use of and/or posting of and/or appearance of the
        Comments on this website.
      </li>
      <li>
        Tanci Craftreserves the right to monitor all Comments and to remove any
      ...
      <li>
        You hereby grant to <strong>Tanci Craft</strong> a non-exclusive
    ...
    <p>
      ...
      visibility associated with the hyperlink outweighs the absence of Tanci
      Craft and (d) where the link is in the context of general resource
    ...
    <p>
      No use of Tanci Craft’s logo or other artwork will be allowed for linking
